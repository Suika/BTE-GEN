...
$sql="UPDATE User SET Closed = 1 WHERE ID = $id LIMIT 1";
                  
mysqli_query($db, $sql);

$sql="UPDATE LNDL SET Closed = 1 WHERE User_ID = $id";
...
$sql = "INSERT INTO Log (`Time`, `Activity`, `User_ID`, `Groups_ID`) VALUES (NOW(), '$zeile[Name] Closed User with ID $id', $zeile[ID], $zeile[Groups_ID])";
mysqli_query($db, $sql);
