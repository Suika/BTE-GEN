...
$sql="UPDATE LNDL SET Visible = 1 WHERE DL_ID = $id LIMIT 1";
...
$sql = "INSERT INTO Log (`Time`, `Activity`, `User_ID`, `Groups_ID`) VALUES (NOW(), '$zeile[Name] Aproved Link with ID $id', $zeile[ID], $zeile[Groups_ID])";
mysqli_query($db, $sql);
